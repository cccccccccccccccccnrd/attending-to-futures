<template>
  <div class="page page-conference">
    <div class="indent">
      ...
      <p>&rarr; How can design itself be employed as a tool to critically examine the socio-political configuration of historical events as well as to create possible futures?</p>
      <p>&rarr; What are the modalities of education as defamiliarization?</p>
