    ...
    return {
      ...
      events: [
        ...
        },
        {
          ...
          title: 'Resonance and Ontological Design: On facilitating and obstructing transformative teaching and learning experiences in design education',
        ...
        },
        {
          ...
          title: '(im)possible exits and silenced affects: design futures and disciplinary mobilities',
        ...
        {
          speaker: ['Polymode Studio / Silas Munro', 'Tasheka Arceneaux', 'Tanvi Sharma', 'Brian Johnson', 'Pierre Bowins'],
